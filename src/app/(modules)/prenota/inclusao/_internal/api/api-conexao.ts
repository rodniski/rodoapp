...
export async function getDfeDetalhesXmlSimples(
    ...
    if (!chaveDFe || typeof chaveDFe !== 'string' || chaveDFe.length !== 44 || !/^\d+$/.test(chaveDFe)) {
        console.log("getDfeDetalhesXmlSimples: chaveDFe inválida:", chaveDFe);
