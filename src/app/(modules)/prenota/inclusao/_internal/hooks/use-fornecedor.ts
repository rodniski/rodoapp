      ...
      try {
        ...
        if (Array.isArray(rawResp)) {
          ...
          try {
            ...
            console.log("[useSearchFornecedorPedidos] Erro ao parsear resposta da API:", parseError);
            console.log("[useSearchFornecedorPedidos] Resposta recebida que causou o erro:", rawResp);
        ...
        console.log("[useSearchFornecedorPedidos] erro na busca ou processamento:", err);
