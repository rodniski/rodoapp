...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log(`${logPrefix} [${requestId}] Erro ao buscar produtos para o termo: "${trimmedSearchTerm}". Detalhes:`, error);
    ...
    console.log(`${logPrefix} [${requestId}] Detalhes do erro formatado:`, errorDetails);
    ...
    await prisma.$disconnect().catch(disconnectError => {
        console.log(`${logPrefix} [${requestId}] Erro ao desconectar do Prisma:`, disconnectError);
    });
  }
}
