...
const footerData: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      { label: "Assinatura", href: "http://hesk.rodoparana.com.br/signaturegen", external: true },
      { label: "Suporte", href: "http://hesk.rodoparana.com.br", external: true },
      { label: "Intranet", href: "https://intranet.rodoparana.com.br/", external: true },
    ],
  },
  {
    title: "Sites",
    links: [
      { label: "Rodoparaná", href: "https://rodoparana.com.br", external: true },
      { label: "Grupo Timber", href: "https://grupotimber.com.br", external: true },
    ],
  },
];
